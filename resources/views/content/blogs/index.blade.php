...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h4 class="mb-1"><i class="ti tabler-news me-2"></i>Blog Posts</h4>
            <p class="text-muted mb-0">Manage your blog articles and content</p>
        </div>
        <a href="{{ route('blogs.create') }}" class="btn btn-primary">
            <i class="ti tabler-plus me-1"></i> Add Post
        </a>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-header pb-0">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                <h5 class="mb-0"><i class="ti tabler-list me-2"></i>All Posts</h5>
            ...
            <div class="bulk-bar d-none py-2 px-3 my-2" id="bulk-bar">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <span class="fw-medium" style="font-size:.85rem">posts selected</span>
                    </div>
        ...
        <div class="table-responsive">
            <table id="blogs-table" class="table table-hover">
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    success: function () {
                        Swal.fire({ icon: 'success', title: 'Deleted!', text: 'Blog post deleted successfully.', timer: 1500, showConfirmButton: false });
                        table.ajax.reload(null, false);
                    },
                    error: function (xhr) {
