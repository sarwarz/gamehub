...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h4 class="mb-1"><i class="ti tabler-clock me-2 text-warning"></i>Pending Sellers</h4>
            <p class="text-muted mb-0">Sellers awaiting approval</p>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="mb-0">{{ format_currency($stats['pending_balance']) }}</h5>
    ...
    <div class="card">
        <div class="card-header pb-0">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                <h5 class="mb-0"><i class="ti tabler-list-details me-2"></i>Pending Sellers</h5>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li>
                                <a class="dropdown-item bulk-status-action" href="#" data-status="active">
                                    <i class="ti tabler-circle-check ti-xs me-2 text-success"></i> Approve (Active)
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item bulk-status-action" href="#" data-status="rejected">
                                    <i class="ti tabler-circle-x ti-xs me-2 text-warning"></i> Reject
                                </a>
                            </li>
...
const PendingSellersPage = {
    ...
    initDataTable() {
        this.table = $('#sellers-table').DataTable({
            ...
            language: {
                emptyTable: '<div class="py-4 text-center"><i class="ti tabler-clock-off ti-xl text-muted mb-2 d-block"></i><span class="text-muted">No pending sellers</span></div>',
...
$(document).ready(() => PendingSellersPage.init());
