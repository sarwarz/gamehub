...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-1"><i class="ti tabler-shield-lock me-2"></i>Privacy Policy</h4>
        <p class="text-muted mb-0">Manage the Privacy Policy page content</p>
    </div>
</div>

<form action="{{ route('static-pages.update', 'privacy') }}" method="POST">
@csrf @method('PUT')
        ...
        <div class="card section-card">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="text" name="title" class="form-control" value="{{ $settings['title'] ?? 'Privacy Policy' }}">
                </div>
                <div class="mb-3">
