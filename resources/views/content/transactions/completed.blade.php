...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h4 class="mb-1"><i class="ti tabler-circle-check me-2 text-success"></i>Completed Transactions</h4>
            <p class="text-muted mb-0">Successfully processed financial transactions</p>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="mb-0">{{ format_currency($stats['completed_volume']) }}</h5>
    ...
    <div class="card">
        <div class="card-header pb-0">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                <h5 class="mb-0"><i class="ti tabler-receipt me-2"></i>Completed Transactions</h5>
...
const CompletedTxPage = {
    ...
    initDataTable() {
        this.table = $('#transactions-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('transactions.completed') }}',
            order: [[7, 'desc']],
            pageLength: 25,
            columns: [
            ...
            language: {
                emptyTable: '<div class="py-4 text-center"><i class="ti tabler-receipt-off ti-xl text-muted mb-2 d-block"></i><span class="text-muted">No completed transactions</span></div>'
            }
        });
    },
...
$(document).ready(() => CompletedTxPage.init());
