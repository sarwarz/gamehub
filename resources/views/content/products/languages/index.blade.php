@extends('layouts.app')
@section('title', 'Product Languages')
...
@section('content')
<div class="app-ecommerce-languages">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold mb-1"><i class="ti tabler-language ti-md me-1 text-primary"></i> Product Languages</h4>
            <p class="text-muted mb-0">Manage supported product languages</p>
        </div>
        <button class="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#offcanvasLanguageList">
            <i class="ti tabler-plus ti-xs me-1"></i> Add Language
        </button>
    </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="avatar avatar-md me-3 bg-label-primary">
                            <i class="ti tabler-language fs-4"></i>
                        </div>
                        <div>
    ...
    <div class="bulk-bar p-3 mb-3 d-none" id="bulk-bar">
        <div class="d-flex align-items-center justify-content-between">
            <span class="fw-semibold"><span id="bulk-count">0</span> language(s) selected</span>
    ...
    <div class="card shadow-sm">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0" id="languages-table" style="width:100%">
    ...
    <!-- Offcanvas Add -->
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasLanguageList">
        <div class="offcanvas-header py-6">
            <h5 class="offcanvas-title">Add Product Language</h5>
        ...
        <div class="offcanvas-body border-top">
            <form method="POST" action="{{ route('languages.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="Enter language name" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="code" class="form-control" placeholder="en, fr, de, es">
                </div>
    ...
    const Page = {
        ...
        initDataTable() {
            this.table = $('#languages-table').DataTable({
                ...
                language: {
                    emptyTable: '<div class="py-4 text-center"><i class="ti tabler-language ti-xl text-muted mb-2 d-block"></i><span class="text-muted">No languages found</span></div>'
                }
            });
        },
                ...
                Swal.fire({
                    ...
                    $.ajax({
                        ...
                        success: () => {
                            ...
                            Swal.fire({ icon: 'success', title: 'Language deleted', showConfirmButton: false, timer: 1500, timerProgressBar: true });
                        },
        ...
        bulkDelete() {
            ...
            Swal.fire({
                ...
                text: `${ids.length} language(s) will be permanently deleted.`,
                icon: 'warning',
                showCancelButton: true,
                confirmButtonText: 'Yes, delete',
                customClass: { confirmButton: 'btn btn-danger me-3', cancelButton: 'btn btn-label-secondary' },
                ...
                if (!r.isConfirmed) return;
                $.post('{{ route('languages.bulk-delete') }}', { ids, _token: '{{ csrf_token() }}' })
                    .done(() => {
                        this.table.ajax.reload(null, false);
                        $('#select-all').prop('checked', false);
                        this.syncBulkBar();
                        Swal.fire({ icon: 'success', title: 'Languages deleted', showConfirmButton: false, timer: 1500, timerProgressBar: true });
                    })
