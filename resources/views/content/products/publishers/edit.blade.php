        ...
        <form method="POST" action="{{ route('publishers.update', $publisher->id) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="slug" class="form-control"
                       value="{{ old('slug', $publisher->slug) }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="description" class="form-control" rows="3">{{ old('description', $publisher->description) }}</textarea>
            </div>
            ...
            <a href="{{ route('publishers.index') }}" class="btn btn-label-danger">Cancel</a>
        </form>
    </div>
</div>
@endsection
