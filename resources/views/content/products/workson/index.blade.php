@extends('layouts.app')
@section('title', 'Product Works On')
...
@section('content')
<div class="app-ecommerce-workson">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold mb-1"><i class="ti tabler-devices ti-md me-1 text-primary"></i> Product Works On</h4>
            <p class="text-muted mb-0">Manage supported operating systems and devices</p>
        </div>
        <button class="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWorksOnList">
            <i class="ti tabler-plus ti-xs me-1"></i> Add Work On
        </button>
    </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="avatar avatar-md me-3 bg-label-primary">
                            <i class="ti tabler-devices fs-4"></i>
                        </div>
                        <div>
    ...
    <div class="bulk-bar p-3 mb-3 d-none" id="bulk-bar">
        <div class="d-flex align-items-center justify-content-between">
            <span class="fw-semibold"><span id="bulk-count">0</span> option(s) selected</span>
    ...
    <div class="card shadow-sm">
        <div class="card-header border-bottom">
            <div class="d-flex flex-wrap justify-content-between align-items-center row-gap-2">
                <h5 class="card-title mb-0">All Works On Options</h5>
            </div>
        </div>
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0" id="workson-table" style="width:100%">
    ...
    <!-- Offcanvas Add -->
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasWorksOnList">
        <div class="offcanvas-header py-6">
            <h5 class="offcanvas-title">Add Work On Option</h5>
        ...
        <div class="offcanvas-body border-top">
            <form method="POST" action="{{ route('workson.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="Enter name (Windows, Mac...)" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="icon" class="form-control" placeholder="icon class or path">
                </div>
...
(function ($) {
    ...
    const Page = {
        ...
        initDataTable() {
            this.table = $('#workson-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('workson.index') }}',
                order: [[1, 'asc']],
                pageLength: 25,
                columns: [
                ...
                language: {
                    emptyTable: '<div class="py-4 text-center"><i class="ti tabler-devices ti-xl text-muted mb-2 d-block"></i><span class="text-muted">No options found</span></div>'
                }
            });
        },
                ...
                Swal.fire({
                    ...
                    $.ajax({
                        ...
                        success: () => {
                            ...
                            Swal.fire({ icon: 'success', title: 'Option deleted', showConfirmButton: false, timer: 1500, timerProgressBar: true });
                        },
        ...
        bulkDelete() {
            ...
            Swal.fire({
                ...
                text: `${ids.length} option(s) will be permanently deleted.`,
                icon: 'warning',
                showCancelButton: true,
                confirmButtonText: 'Yes, delete',
                customClass: { confirmButton: 'btn btn-danger me-3', cancelButton: 'btn btn-label-secondary' },
                ...
                if (!r.isConfirmed) return;
                $.post('{{ route('workson.bulk-delete') }}', { ids, _token: '{{ csrf_token() }}' })
                    .done(() => {
                        this.table.ajax.reload(null, false);
                        $('#select-all').prop('checked', false);
                        this.syncBulkBar();
                        Swal.fire({ icon: 'success', title: 'Options deleted', showConfirmButton: false, timer: 1500, timerProgressBar: true });
                    })
